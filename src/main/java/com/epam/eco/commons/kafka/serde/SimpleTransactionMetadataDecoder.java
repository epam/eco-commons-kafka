 ...
 */
public class SimpleTransactionMetadataDecoder implements KeyValueDecoder<String, TransactionMetadata> {
    ...
    public TransactionMetadata decodeValue(String key, byte[] valueBytes) {
        ...
        return TransactionLog.readTxnRecordValue(key, byteBuffer).getOrElse(() -> null);
    }
