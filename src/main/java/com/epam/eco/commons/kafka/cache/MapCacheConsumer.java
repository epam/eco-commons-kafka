...
import com.epam.eco.commons.kafka.consumer.bootstrap.ToMapDecodingRecordCollector;
import com.epam.eco.commons.kafka.consumer.bootstrap.ToMapRecordCollector;
import com.epam.eco.commons.kafka.serde.KeyValueDecoder;

/**
 * @author Andrei_Tytsik
 */
class MapCacheConsumer<K, V> implements Closeable {
    ...
    public MapCacheConsumer(
            ...
            int parallelism,
            Consumer<Map<K, V>> consumerHandler) {
    ...
    private static <K, V> BootstrapConsumerExecutor<?, ?, Map<K, V>> initExecutor(
            ...
            int parallelism,
            Consumer<Map<K, V>> consumerHandler) {
        BootstrapConsumer.Builder<K, V, Map<K, V>> consumerBuilder =
                BootstrapConsumer.<K, V, Map<K, V>>builder().
                    topicName(topicName).
        ...
        Supplier recordCollectorSupplier = () ->
                ...
                new ToMapDecodingRecordCollector(keyValueDecoder) :
                new ToMapRecordCollector();
